...
const ManageUsers = () => {
    ...
    const {
        ...
        queryKey: ["users"],
        queryFn: () =>
            getAllHandler(`https://cmcserver-geethikas-projects-ec00e83f.vercel.app/api/v1/users`),
    });
    ...
    const UpdateUserRole = async (id, role) => {
        ...
        try {
            const response = await axios.patch(
                `https://cmcserver-geethikas-projects-ec00e83f.vercel.app/api/v1/admin/update-role`,
                updateUser,
