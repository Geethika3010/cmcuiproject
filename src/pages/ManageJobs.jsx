...
const ManageJobs = () => {
    const {
        ...
        queryFn: () =>
            getAllHandler(
                `https://cmcserver-geethikas-projects-ec00e83f.vercel.app/api/v1/jobs/my-jobs`
            ),
    });
    ...
    const deleteJobHandler = async (id) => {
        try {
            const response = await axios.delete(
                `https://cmcserver-geethikas-projects-ec00e83f.vercel.app/api/v1/jobs/${id}`,
            ...
            // setJobs(updateJobs);
            // handleJobFetch(
            //     `https://cmcserver-geethikas-projects-ec00e83f.vercel.app/api/v1/jobs?page=1`
            // );
            refetch();
            Swal.fire({
                title: "Deleted!",
