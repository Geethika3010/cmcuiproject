...
const Stats = () => {
    ...
    const { isPending, isError, data, error } = useQuery({
        ...
        queryFn: () =>
            getAllHandler(
                `https://cmcserver-geethikas-projects-ec00e83f.vercel.app/api/v1/admin/stats`
            ),
    });
...
.PieChartContainer .recharts-responsive-container {
    width: 100%;
    height: auto;
}
...
.PieChartContainer .recharts-legend {
    margin-top: 1rem;
}

.PieChartContainer .recharts-legend-item {
    font-size: 0.9rem;
    margin-right: 1rem;
    display: flex;
    align-items: center;
...
.PieChartContainer .recharts-legend-item:hover {
    opacity: 0.8;
}

.PieChartContainer .recharts-legend-item-text {
    font-weight: bold;
    margin-left: 0.5rem;
}

/* Bar and Area Chart Styles */
.ChartContainer {
    margin-top: 2rem;
}
...
.ChartContainer .recharts-cartesian-grid {
    stroke: #ddd;
}

.ChartContainer .recharts-tooltip {
...
.ChartContainer .recharts-legend {
    margin-top: 1rem;
}

.ChartContainer .recharts-legend-item {
    font-size: 0.9rem;
    margin-right: 1rem;
    display: flex;
    align-items: center;
...
.ChartContainer .recharts-legend-item:hover {
    opacity: 0.8;
}

.ChartContainer .recharts-legend-item-text {
    font-weight: bold;
    margin-left: 0.5rem;
}
`;
