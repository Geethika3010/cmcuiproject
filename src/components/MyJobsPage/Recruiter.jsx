...
const Recruiter = () => {
    const {
        ...
        queryFn: async () => {
            const response = await axios.get(
                `https://cmcserver-geethikas-projects-ec00e83f.vercel.app/api/v1/application/recruiter-jobs`,
                {
    ...
    const handleAcceptStatus = (id, recruiterId) => {
        ...
        updateJobStatusMutation.mutate({
            body: newStatus,
            url: `https://cmcserver-geethikas-projects-ec00e83f.vercel.app/api/v1/application/${id}`,
        });
    };
