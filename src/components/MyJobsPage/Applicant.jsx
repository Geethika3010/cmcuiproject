...
const Applicant = () => {
    const {
        ...
        queryFn: async () => {
            const response = await axios.get(
                `https://cmcserver-geethikas-projects-ec00e83f.vercel.app/api/v1/application/applicant-jobs`,
    ...
    if (isError) {
        return <h2 className="text-lg md:text-3xl font-bold text-red-600 text-center mt-12">Job List is Empty</h2>;
    }
